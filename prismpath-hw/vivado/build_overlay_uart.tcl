...
create_project -force ppt_datapath_uart $out/proj -part $part
...
file copy -force [lindex $hwh 0] $out/ppt_datapath_uart.hwh
puts "UART OVERLAY BUILD DONE: $out/ppt_datapath_uart.bit (+ .hwh) | PS7: $ps7_source"
