...
create_project -force ppt_overlay $out/proj -part $part
...
file copy -force [lindex $hwh 0] $out/ppt_overlay.hwh
puts "OVERLAY BUILD DONE: $out/ppt_overlay.bit (+ .hwh) | PS7: $ps7_source"
