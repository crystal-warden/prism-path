...
- Capacity: **~17–171 client networks per box**, depending on escalation rate (the master lever).
...
- Corpus v2: **47,812 malicious flows, 66 families, 2016–2026** (internal corpus).
- **Cross-family leave-one-out recall@0.95: macro 0.224 / micro 0.256** (generalization to unseen
  families — real, modest); temporal holdout (≤2023 → 2024–26) **0.333**; ROC-AUC **0.831**.
