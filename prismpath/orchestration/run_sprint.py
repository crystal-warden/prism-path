...
from prismpath.orchestration.gates import token_est   # noqa: E402
...
GATE_PLUGIN = None
if GATE == "browser":
    from prismpath.orchestration.gates import validate_browser as validate_fn    # noqa: E402
...
if AGENT_BACKEND == "swarm":
    from prismpath.orchestration.hermes_swarm import (dispatch as _swarm_dispatch, setup_roles as _setup_roles,  # noqa: E402
                                     reflect as _reflect)
    _setup_roles()
