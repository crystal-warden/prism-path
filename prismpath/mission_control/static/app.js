...
const STYLE = [
  { selector: "node", style: { label: "data(label)", "background-color": "#0e1a2e", "border-width": 1.5,
    "border-color": "#3a5f8a", color: "#cfe3ff", "font-size": 11, "font-family": "monospace",
  ...
  { selector: "node.start", style: { "border-color": "#7fd1ff", "border-width": 3 } },
  { selector: "node.terminal", style: { "background-color": "#10243c", "border-color": "#34d3b0" } },
  { selector: "node.active", style: { "border-color": "#7fd1ff", "border-width": 4, "background-color": "#12345a" } },
  { selector: "node.v-yes", style: { "border-color": "#34d3b0", "border-width": 3 } },
  { selector: "node.v-may", style: { "border-color": "#f4b740", "border-width": 3 } },
  { selector: "node.v-no", style: { "border-color": "#5a6b82", "border-width": 3, "background-color": "#0a121e" } },
  { selector: "edge", style: { width: 2, "curve-style": "bezier", "target-arrow-shape": "triangle",
    "line-color": "#3a5f8a", "target-arrow-color": "#3a5f8a", label: "data(label)", "font-size": 9,
    color: "#6b8bb0", "text-background-color": "#070b12", "text-background-opacity": 0.85,
    "text-background-padding": 2, "text-rotation": "autorotate" } },
  { selector: "edge.deterministic", style: { "line-color": "#34d3b0", "target-arrow-color": "#34d3b0" } },
  { selector: "edge.semantic", style: { "line-color": "#f4b740", "target-arrow-color": "#f4b740" } },
  { selector: "edge.error", style: { "line-color": "#ff6b6b", "target-arrow-color": "#ff6b6b" } },
  { selector: "edge.event", style: { "line-color": "#b98cff", "target-arrow-color": "#b98cff" } },
  { selector: "edge.nonm", style: { "line-style": "dashed", "line-color": "#ff9d3c", "target-arrow-color": "#ff9d3c", width: 3 } },
];
