...
sha256sum -c prismpath/telemetry/evidence/SHA256SUMS
...
ots verify prismpath/telemetry/evidence/SHA256SUMS.ots
```
...
```
ots upgrade prismpath/telemetry/evidence/SHA256SUMS.ots
```
