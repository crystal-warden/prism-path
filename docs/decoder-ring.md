...
- **[Part 2 — Glossary](#part-2--glossary-az)**: A–Z, one or two sentences each.
...
The conventional reading (Landis & Koch): >0.80 "almost perfect", 0.61–0.80 "substantial",
0.41–0.60 "moderate".
...
max train–test cosine is 0.887, i.e. nothing is a near-copy.
...
[prism-path-hw](https://github.com/crystal-warden/prism-path-hw), the fragment's first hardware
...
([prism-path-hw](https://github.com/crystal-warden/prism-path-hw)).
...
[research/primer-students-guide.md](research/primer-students-guide.md) → ideas 1–3 above. That's it.
